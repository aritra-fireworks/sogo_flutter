...
class ResetViaEmailPopup extends StatelessWidget {
  final VoidCallback? onClickNext;
  final TextEditingController controller;
  ResetViaEmailPopup({Key? key, this.onClickNext, required this.controller}) : super(key: key);

  final FocusNode _resetPasswordEmailFocus = FocusNode();
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text("Please enter your email for us to send the instruction for retrieving your account password", style: TextStyle(fontFamily: "GothamBook", fontSize: 15.sp, color: AppColors.lightBlack),),
                  SizedBox(height: 20.h,),
                  SizedBox(
                    height: 40,
                    child: TextField(
                      controller: controller,
                      focusNode: _resetPasswordEmailFocus,
                  ...
                  RoundButton(
                    ...
                    onPressed: () {
                      if(controller.text.isEmpty) {
                        ...
                        _resetPasswordEmailFocus.requestFocus();
