...
class MemberPrivilegesDetails extends StatefulWidget {
  final String promotionId;
  const MemberPrivilegesDetails({Key? key, required this.promotionId}) : super(key: key);

  @override
  State<MemberPrivilegesDetails> createState() => _MemberPrivilegesDetailsState();
}

class _MemberPrivilegesDetailsState extends State<MemberPrivilegesDetails> {
                      ...
                      switch (snapshot.data!.status) {
                        ...
                        case Status.COMPLETED:
                          ...
                          if(snapshot.data?.data?.news != null && snapshot.data!.data!.news!.isNotEmpty){
                            return privilegeDetailsBody(context, snapshot.data!.data!.news!.first);
                          }
                          return Center(
  ...
  Widget privilegeDetailsBody(BuildContext context, News promotionDetails) {
    bool showYear = true;
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RoundOutlineButton(onPressed: (){}, borderRadius: 9, child: Row(
